<template>
    <div v-loading="loading" class="transfer__body" :element-loading-text="'加载中'" :style="{ height }">
        <div class="transfer-pane">
            <div class="transfer-pane__tools">
                <el-input v-model="filterText" placeholder="输入关键词进行搜索" />
            </div>
