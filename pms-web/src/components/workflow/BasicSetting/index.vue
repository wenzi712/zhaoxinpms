<template>
    <div class="setting-container">
        <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px" label-position="right">
            <el-form-item label="流程名称" prop="flowName">
                <el-input v-model="formData.flowName" placeholder="请输入流程名称" clearable :style="{ width: '100%' }"></el-input>
            </el-form-item>
            <el-form-item label="流程编码" prop="flowCode">
                <el-input v-model="formData.flowCode" placeholder="请输入流程编码" clearable :style="{ width: '100%' }"></el-input>
            </el-form-item>
            <!--
      ...
      -->
            <el-form-item label="模板图标" prop="icon">
                ...
                <div style="vertical-align: middle">
                    <el-button plain size="mini" style="margin-left: 10px" @click="dialogVisible = true">选择图标</el-button>
                    <el-color-picker
                        v-model="formData.flowIconBackground"
                        title="图标背景色"
      ...
      -->
        ...
        <el-dialog title="选择图标" :visible.sync="dialogVisible" width="612px" height="500px">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button
                    ...
                    @click="
                        dialogVisible = false;
                        selectedIcon = formData.flowIcon;
                    "
                >
                    取 消
                </el-button>
                <el-button
                    ...
                    @click="
                        dialogVisible = false;
                        formData.flowIcon = selectedIcon;
                    "
                >
                    确 定
                </el-button>
