<template>
    <el-row :gutter="12">
        <el-col :span="isRange ? 24 : 12">
            <el-select v-model="cloneData.type" size="small" placeholder="请选择" style="width: 100%" @change="onTypeChange">
        ...
        <el-col :span="isRange ? 24 : 12">
            ...
            <div v-else style="width: 100%; overflow: hidden; margin-top: 10px">
                <el-col :span="6" style="padding-left: 0">
                    <el-input-number v-model="cloneData.value[0]" size="small" controls-position="right" style="width: 100%" @change="update"></el-input-number>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="6" style="padding-left: 0">
                    <el-input-number v-model="cloneData.value[3]" size="small" controls-position="right" style="width: 100%" @change="update"></el-input-number>
                </el-col>
            </div>
        </el-col>
    </el-row>
