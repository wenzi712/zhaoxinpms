...
<template>
    <div class="right-board">
        ...
        <i class="el-icon-link" />
          ...
          <el-form-item v-if="activeData.layout==='rowFormItem'" label="布局模式">
            <el-radio-group v-model="activeData.type">
              ...
              <el-radio-button label="flex" />
                    ...
                    <el-form-item
                        v-if="activeData.vModel !== undefined && activeData.layout !== 'rowFormItem' && notObject(activeData.defaultValue)"
                        label="默认值"
                    >
          ...
          <el-form-item v-if="activeData['suffix-icon'] !== undefined" label="后图标">
            ...
            <el-input v-model="activeData.separator" placeholder="请输入选项分隔符" />
                    ...
                    <el-form-item v-if="activeData.tag === 'fc-input-table'" label="类型">
                        <el-select v-model="activeData.type" size="small">
          ...
          >
            <el-switch v-model="activeData.border" />
                    ...
                    <template v-if="activeData.tag === 'fc-org-select'">
                        <el-form-item v-if="activeData.title !== undefined" label="弹框名称">
                            <el-input v-model="activeData.title" placeholder="请输入弹框名称" />
                        </el-form-item>

                        <el-form-item v-if="activeData.maxNum !== undefined" label="可选数量">
                        ...
                        <template v-if="activeData.buttonType === 'button' && activeData.tagConfig">
                            ...
                            <el-form-item v-if="activeData.tagConfig.size !== undefined" label="大小">
                            ...
                            <el-form-item v-if="activeData.tagConfig.effect !== undefined" label="主题">
                            ...
                            <el-form-item v-if="activeData.tagConfig.type !== undefined" label="标签样式">
                            ...
                            <el-form-item v-if="activeData.tagConfig['disable-transitions'] !== undefined" label="渐变动画">
                                <el-switch
                            ...
                            <el-form-item v-if="activeData.tagConfig.hit !== undefined" label="边框描边">
          ...
          <el-form-item
                        v-if="
                            activeData.size !== undefined && (activeData.optionType === 'button' || activeData.border || activeData.tag === 'el-color-picker')
                        "
                        label="选项尺寸"
                    >
...
<el-switch />
          ...
          <el-form-item v-if="activeData.disabled !== undefined" label="是否禁用">
            <el-switch v-model="activeData.disabled" />
                    ...
                    <el-form-item v-if="activeData.expression !== undefined" label="计算公式">
                        <div class="pane-calc-preview" @click="expDialogVisible = true">
                            <span
          ...
          <el-form-item v-if="activeData.required !== undefined" label="是否必填">
                        <el-switch v-model="activeData.required" :disabled="!couldChangeRequire" @change="requireChange" />
          ...
          <el-form-item v-if="activeData.tag === 'el-select'" label="是否多选">
                    ...
                    <el-form-item v-if="activeData.cmpType === 'custom'" label="组件说明">
                        <el-input v-model="activeData.explain" type="textarea" />
                    </el-form-item>
                    <!-- draggable -->
        ...
        <el-dialog title="编辑计算公式" custom-class="calc-dialog" :visible.sync="expDialogVisible" width="600px">
            <div class="calc-box">
                ...
                <div>
                    <span>计算对象：</span>
                    <span v-for="item in calculateCmps" :key="item.vModel" class="calc-btn" @click="expressionTemp.push(item)">
                        {{ item.label }}
                    </span>
                </div>
                <div style="margin: 10px 0">
                    <span>计算符号：</span>
                    <span v-for="item in ['+', '-', '×', '÷', '(', ')']" :key="item" class="calc-btn" @click="expressionTemp.push(item)">{{ item }}</span>
                </div>
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" size="mini" @click="checkExpression">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
