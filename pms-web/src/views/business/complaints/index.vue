    ...
    <div class="Jcommon-layout">
            ...
            <div class="Jcommon-layout-main Jflex-main">
                <div class="Jcommon-head">
                    <el-row :gutter="10" class="mb8">
                        <el-col :span="1.5">
                            <el-button v-hasPermi="['business:complaints:add']" type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd">
                                新增
                            </el-button>
                        </el-col>
                    </el-row>
        ...
        <el-dialog class="Jdialog Jdialog_center" :title="title" :visible.sync="open" width="600px" append-to-body lock-scroll>
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                ...
                <el-form-item v-if="form.client != 'web_company'" label="商户编号" prop="applyHouse">
