    ...
    <div class="app-container">
        <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true">
            <el-form-item label="KEY" prop="key">
                <el-input v-model="queryParams.key" placeholder="请输入KEY" clearable size="small" style="width: 240px" @keyup.enter.native="handleQuery" />
            </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button v-hasPermi="['activiti:modeler:add']" type="primary" icon="el-icon-plus" size="mini" @click="handleAdd">创建新模型</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="modelerList">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button v-hasPermi="['activiti:modeler:edit']" size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)">
                        修改
                    </el-button>
                    <el-button v-hasPermi="['activiti:modeler:deploy']" size="mini" type="text" icon="el-icon-upload2" @click="handleDeploy(scope.row)">
                        部署
                    </el-button>
                    <el-button v-hasPermi="['activiti:modeler:export']" size="mini" type="text" icon="el-icon-download" @click="handleExport(scope.row)">
                        导出
                    </el-button>
                    <el-button v-hasPermi="['activiti:modeler:remove']" size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)">
                        删除
                    </el-button>
                </template>
            </el-table-column>
