<template>
    <div class="app-container">
        <el-form ref="queryForm" :model="queryParams" v-show="showSearch" :inline="true">
            <el-form-item label="KEY" prop="key">
                <el-input v-model="queryParams.key" placeholder="请输入流程KEY" clearable size="small" style="width: 240px" @keyup.enter.native="handleQuery" />
            </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" icon="el-icon-upload" size="mini" @click="handleUpload">部署流程定义</el-button>
      ...
      <el-table-column label="流程图" align="center" prop="diagramResourceName" width="120">
        <template slot-scope="scope">
          ...
          />
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-sort" @click="handleState(scope.row)">
                        {{ scope.row.suspendState === '2' ? '激活' : '挂起' }}
                    </el-button>
                    <el-button size="mini" type="text" icon="el-icon-refresh" @click="handleConvert(scope.row)">转模型</el-button>
        ...
        <!-- 部署流程定义对话框 -->
        <el-dialog v-bind="$attrs" v-on="$listeners" @open="onOpen" :title="title" @close="onClose" :visible.sync="open" width="500px" append-to-body>
            <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px">
                <el-form-item label="上传" prop="upload" required>
                    <el-upload ref="upload" :file-list="uploadfileList" :action="uploadAction" :before-upload="uploadBeforeUpload">
